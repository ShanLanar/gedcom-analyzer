...
_HELP_TEXTS = {
    ...
    "ancestry_csv": (
        ...
        "  Auf der Start-Seite oben: Login-Bereich → Herunterladen\n\n"
        ...
        "  4. Auf der Start-Seite: Cookie-Datei wählen → Login"
    ),
    "mh_csv": (
    ...
    "cookie_editor": (
        ...
        "  5. Auf der Start-Seite: Login-Bereich →\n"
        "     Cookie-Datei auswählen und Login-Button klicken\n\n"
        "Gilt auch für MH:\n"
