...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "tt.mf_page_prev": {"de": "Vorherige Seite (je 2000 Treffer nach cM)",
                        "en": "Previous page (2000 hits by cM each)"},
    "tt.mf_page_next": {"de": "Nächste Seite (je 2000 Treffer nach cM)",
                        "en": "Next page (2000 hits by cM each)"},
