"""PersonsTabMixin – Tab „👪 Personen" für AncestryDnaApp.
...
Portiert den Stammbaum aus dem früheren Standalone-viewer.py, jetzt nativ
in der Haupt-App (heller Look, App-Konventionen, keine DB-Arbeit beim Aufbau).
"""
...
class PersonsTabMixin:
    """Mixin mit dem Personen-/Stammbaum-Tab für AncestryDnaApp."""
