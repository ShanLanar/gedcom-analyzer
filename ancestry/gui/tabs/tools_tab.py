"""ToolsTabMixin – Tab „🔧 Werkzeuge" für AncestryDnaApp.
...
class ToolsTabMixin:
    """Mixin mit dem Werkzeuge-Tab für AncestryDnaApp."""
    ...
    def _build_tab_tools(self):
        ...
        ttk.Label(head, text="  Externe Sammel-/Import-Tools – laufen im "
                  ...
                  foreground=self._active_colors().get("text_dim", "#888888")
        ...
        canvas = tk.Canvas(left_wrap, highlightthickness=0,
                           bg=self._active_colors().get("bg", "#ffffff"))
